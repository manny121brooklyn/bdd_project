...
class Language:
    ...
    :type alphabet: str
    :ivar wiki_start_pages: The Wikipedia page to start from if we're crawling
...
LANGUAGES = {
    ...
    # simple way to get the Latin alphabet page from Wikipedia through
    ...
    "Vietnamese": Language(
        ...
        # dozens of 8-bit Vietnamese code page are
